...
import AppData from './loaddata/AppData';
import AppT from './todook/AppT';
import AppContext from './context/AppContext';
import AppR from './renderProps/AppR';
		...
		<div className="App">
			<BrowserRouter>
				...
				<Switch>
					...
					<Route path="/rescard" component={CardParent} />
					<Route path="/undo" component={Undo} />
					<Route path="/load" component={AppData} />
					<Route path="/dodo" component={AppT} />
					<Route path="/context" component={AppContext} />
					<Route path="/rp" component={AppR} />
				</Switch>
			</BrowserRouter>
		</div>
	);
